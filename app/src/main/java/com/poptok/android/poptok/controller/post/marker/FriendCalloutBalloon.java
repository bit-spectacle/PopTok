...
//            ((ImageView) defaultCalloutBalloon.findViewById(R.id.imagePost)).setImageResource(R.drawable.ic_launcher);
//            ((TextView) defaultCalloutBalloon.findViewById(R.id.textPost)).setText(poiItem.getItemName());
//            ((TextView) defaultCalloutBalloon.findViewById(R.id.textTag)).setText("지니 귀여워");
