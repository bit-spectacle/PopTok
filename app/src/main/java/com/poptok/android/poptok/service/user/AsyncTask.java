...
public abstract class AsyncTask<ResultT> implements Callable<ResultT> {
    ...
    public AsyncTask<ResultT> executor( Executor executor ) {
        this.executor = executor;
        return this;
    }
    ...
    public AsyncTask<ResultT> handler( Handler handler ) {
        this.handler = handler;
        return this;
    }
    ...
    public static class Task<ResultT> implements Callable<Void> {
        ...
        protected AsyncTask<ResultT> parent;
        protected Handler handler;

        public Task(AsyncTask<ResultT> parent) {
            this.parent = parent;
    ...
    public AsyncTask<ResultT> setOnExceptionListener( OnExceptionListener onExceptionListener ) {
